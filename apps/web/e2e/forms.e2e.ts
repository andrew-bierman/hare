...
// Agent creation form requires authentication - test redirect
baseTest.describe('Agent Creation Form - Auth Redirect', () => {
	baseTest('agent creation page redirects to sign-in for unauthenticated users', async ({
		page,
	}: { page: Page }) => {
...
// Settings form tests are covered in settings.e2e.ts with proper authentication
