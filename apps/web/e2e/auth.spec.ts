...
test.describe('Authentication', () => {
	...
	test('should have email and password fields on sign-in', async ({ page }) => {
		await page.goto('/sign-in')
	...
	test('should have email, name, and password fields on sign-up', async ({ page }) => {
		await page.goto('/sign-up')
	...
	test('should show agents page', async ({ page }) => {
