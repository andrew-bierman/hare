/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 0b6ead5d301bd21bfde2425ebcef6af9)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "HareAgent" | "HareMcpAgent";
	}
	interface Env {
		KV: KVNamespace;
		HARE_AGENT: DurableObjectNamespace<import("./custom-worker").HareAgent>;
		MCP_AGENT: DurableObjectNamespace<import("./custom-worker").HareMcpAgent>;
		R2: R2Bucket;
		DB: D1Database;
