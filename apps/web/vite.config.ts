...
export default defineConfig({
	...
	resolve: {
		alias: {
			// Path polyfill for client-side (fumadocs uses path.join in browser)
			path: path.resolve(__dirname, './src/lib/polyfills/path-browser.ts'),
			// Fumadocs MDX collections - these are virtual modules generated by fumadocs-mdx plugin
			// Using relative paths to avoid absolute path bundling issues with Cloudflare Workers
