...
export default defineConfig({
	...
	resolve: {
		alias: {
			...
			'@hare/api/client': path.join(packagesPath, 'api/src/elysia/client.ts'),
			'@hare/api/schemas': path.join(packagesPath, 'api/src/schemas/index.ts'),
			'@hare/api/services': path.join(packagesPath, 'api/src/services/index.ts'),
			'@hare/api': path.join(packagesPath, 'api/src/elysia/index.ts'),
