...
export const CreateAgentSchema = z.object({
	name: z
		...
		.max(AGENT_VALIDATION.name.max, `Name must be at most ${AGENT_VALIDATION.name.max} characters`)
		.trim(),
	description: z
		.string()
		.max(
 ...
 */
export const DeploymentEndpointsSchema = z.object({
	chat: z.string(),
	websocket: z.string(),
	state: z.string(),
})
 ...
 */
export const AgentVersionsQuerySchema = z.object({
