...
export const GuardrailTypeSchema = z
	.enum([
		'content_filter',
		'topic_restriction',
		'pii_protection',
	...
	.openapi({ example: 'content_filter' })

export const GuardrailActionSchema = z
	.enum(['block', 'warn', 'redact', 'log'])
...
export const GuardrailConfigSchema = z
	...
	.openapi('GuardrailConfig')

export const GuardrailSchema = z
	.object({
		id: z.string().openapi({ example: 'gr_abc123' }),
		agentId: z.string(),
		name: z.string(),
...
export const CreateGuardrailSchema = z
	.object({
		...
		message: z
			...
			.optional()
			.openapi({ description: 'Custom message shown when guardrail triggers' }),
	})
	.openapi('CreateGuardrail')

export const UpdateGuardrailSchema = z
	.object({
	...
	.openapi('UpdateGuardrail')

export const GuardrailViolationSchema = z
	.object({
		id: z.string(),
