...
export const ConversationOutcomeEnum = z
	.enum(['resolved', 'escalated', 'abandoned', 'ongoing'])
	.openapi({ example: 'resolved' })

export const ConversationOutcomeSchema = z
	.object({
		id: z.string(),
...
export const BusinessMetricsSchema = z
	.object({
