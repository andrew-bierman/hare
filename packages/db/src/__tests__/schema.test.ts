...
const MIGRATION_STATEMENTS = [
	...
	// Workspaces table
	`CREATE TABLE IF NOT EXISTS "workspaces" ("id" text PRIMARY KEY NOT NULL, "name" text NOT NULL, "slug" text NOT NULL UNIQUE, "description" text, "ownerId" text NOT NULL REFERENCES "user"("id") ON DELETE CASCADE, "stripeCustomerId" text, "stripeSubscriptionId" text, "planId" text DEFAULT 'free', "currentPeriodEnd" integer, "creditsBalance" integer DEFAULT 1000 NOT NULL, "freeCreditsResetAt" integer, "createdAt" integer NOT NULL, "updatedAt" integer NOT NULL)`,
