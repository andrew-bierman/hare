/**
 * Project scaffolding templates for @hare/cli
 *
 * Extracted into a separate module so they can be imported by tests
 * without triggering the CLI entry point side effects.
 */
