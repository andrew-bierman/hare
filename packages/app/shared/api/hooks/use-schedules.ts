...
import { schedules } from '@hare/api-client'
...
export function useScheduleQuery(input: UseScheduleInput) {
	...
	return useQuery({
		...
		queryFn: async () => {
			const res = await schedules[':agentId'].schedules[':scheduleId'].$get({
...
export function useScheduleExecutionsQuery(input: UseScheduleExecutionsInput) {
	...
	return useQuery({
		...
		queryFn: async () => {
			const res = await schedules[':agentId'].schedules[':scheduleId'].executions.$get({
				param: { agentId: agentId!, scheduleId: scheduleId! },
				query: {
...
export function useAgentExecutionsQuery(input: UseAgentExecutionsInput) {
	...
	return useQuery({
		...
		queryFn: async () => {
			const res = await schedules[':agentId'].executions.$get({
				param: { agentId: agentId! },
				query: {
					workspaceId: workspaceId!,
					limit: params?.limit,
