 ...
 */
// biome-ignore lint/correctness/noUnusedVariables: utility helper kept for future tests
function getLastMockInstance(): MockWebSocket {
	const instance = mockWebSocketInstances[mockWebSocketInstances.length - 1]
	if (!instance) {
